...
int                               ESSclassify2(const int pntdim, double *pnt, int (*fnc)(double *, double *), double dytol, double rhstol,
                                              const int R0index, double *EVmaxJ, double *EVmaxJs, double *EVmaxH, double *zC01z, const int detecting);
...
int                               FindPoint2(const int, double *, double *, double *, double, double, const int, int (*)(double *, double *));
...
int                               FindEBP(const int pntdim, double *pnt, int (*fnc)(double *, double *), double dytol, double rhstol,
const int R0index,  double *EVmaxH,  const int detecting);
